...
graph TD
    ...
    subgraph AZ_A [Availability Zone A - 2 Instances]
        ELB_A -->|25% Traffic| Target_A1["EC2 Target 1 (25%)"]
        ELB_A -->|25% Traffic| Target_A2["EC2 Target 2 (25%)"]
    end

    subgraph AZ_B [Availability Zone B - 8 Instances]
        ELB_B -->|6.25%| Target_B1["EC2 Target 1 (6.25%)"]
        ELB_B -->|6.25%| Target_B2["EC2 Target 2 (6.25%)"]
        ELB_B -->|6.25%| Target_B3_B8["EC2 Target 3 - 8 (6 x 6.25%)"]
    end

    style ELB_A fill:#fab1a0,stroke:#e17055,stroke-width:2px
    style ELB_B fill:#fab1a0,stroke:#e17055,stroke-width:2px
    style Target_A1 fill:#ff8282,stroke:#d63031
    style Target_A2 fill:#ff8282,stroke:#d63031
    style Target_B1 fill:#d4edda,stroke:#28a745
    style Target_B2 fill:#d4edda,stroke:#28a745
    style Target_B3_B8 fill:#d4edda,stroke:#28a745
```
