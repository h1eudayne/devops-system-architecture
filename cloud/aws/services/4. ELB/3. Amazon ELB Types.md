...
*   **Trao đổi traffic qua GLB Endpoints**: GLB sử dụng các điểm cuối chuyên dụng (**Gateway Load Balancer Endpoints - GWLBE**) để thiết lập kết nối và trao đổi traffic mạng một cách an toàn giữa VPC của nhà cung cấp dịch vụ (Service Provider VPC - nơi chạy firewall) và VPC của khách hàng sử dụng dịch vụ (Consumer VPC).
