...
3.  **Cấu hình thông số ổ đĩa**:
    ...
    *   **Availability Zone**: ⚠️ **LƯU Ý CỰC KỲ QUAN TRỌNG**: Nhấp chọn chính xác phân vùng AZ của instance bạn vừa kiểm tra ở *Bước 1* (ví dụ: `ap-southeast-1a`). Nếu chọn sai vùng, bạn sẽ không thể kết nối ổ cứng này tới máy ảo.
